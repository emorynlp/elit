...
from elit.common.dataset import TransformDataset, PadSequenceDataLoader
from elit.common.transform import VocabDict
from elit.common.vocab import VocabWithFrequency
from elit.components.amr.amr_parser.amrio import AMRIO
from elit.components.amr.amr_parser.data import END, DUM, list_to_tensor, lists_of_string_to_tensor, NIL, REL
from elit.components.amr.amr_parser.transformer import SelfAttentionMask
from elit.transform.transformer_tokenizer import TransformerSequenceTokenizer
from elit.utils.util import merge_list_of_dict


class AbstractMeaningRepresentationDataset(TransformDataset):
